...
using PassMeta.DesktopApp.Ui.Models.PassFileRestoreWin.Models;
using ReactiveUI;
using Splat;
using ReactCommand = ReactiveUI.ReactiveCommand<System.Reactive.Unit, System.Reactive.Unit>;

namespace PassMeta.DesktopApp.Ui.Models.PassFileRestoreWin;
...
public class PassFileRestoreWinViewModel : ReactiveObject
{
    ...
    public PassFileRestoreWinViewModel(PwdPassFile passFile)
    {
        _passFile = passFile;
